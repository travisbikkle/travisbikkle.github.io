...
## TL;DR
[Algolia](https://docsearch.algolia.com/docs/templates/) 沒有將 hugo 的 crawler 模板放上去，因爲 hugo 是基於主題的，而每個主題使用的 css 都不一樣。

如果你使用 hbstack，你可以參考我的 crawler 配置

```javascript
new Crawler({
  appId: &#34;xxxxxxxxx&#34;,  // 更改爲你的appId
  apiKey: &#34;xxxxxxxxxx&#34;,  // 更改爲你的apiKey
  rateLimit: 8,
  maxDepth: 10,
  startUrls: [&#34;https://travisbikkle.github.io/&#34;],
  // 注意這裏的多語言鏈接，和你hugo.yaml中的配置有關係，你可能是單站點，如zh-hant.youdomain.com
  sitemaps: [
...
你應該參考 [HBstack 官方網站的 params.yaml](https://github.com/hbstack/site/blob/main/config/_default/params.yml) 進行配置，建議 fork 一份全局搜索 `docsearch`，看懂並不難。


## 禁用 HBStack 中默認的 search 插件
配置好 Algolia 後，按 &lt;kbd&gt;CTRL K&lt;/kbd&gt; 會彈出兩個窗口。
...
> URL: https://travisbikkle.github.io/zh-hant/2024/01/hugo-hbstack-algolia/  
