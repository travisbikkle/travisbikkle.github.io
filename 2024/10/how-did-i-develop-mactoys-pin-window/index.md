...
说明：
1. 主屏（2560x1440），左下角原点(0,0)，副屏（1920x1080），左下角原点(2560,360)。
2. 主屏和副屏的排列方式为，上边缘对齐
3. 每个屏幕都会有25px的保留区域，可以认为是系统顶部的状态栏
...
以上是我在开发 MacToys 的屏幕置顶功能的一部分过程。

### MacToys 中的 Always On Top 置顶功能

![alt text](/images/posts/make-mactoys/macos-always-on-top.png)

你可以使用 `⌃ &#43; 左键` 单击窗口置顶，也可以使用快捷键选择。你可以使用同样的`⌃ &#43; 左键`单击已经置顶的窗口取消置顶，或者，右键单击，在弹出菜单中取消置顶。

你还可以将这些快捷键改成你喜欢的选择。

MacToys 中还有很多类似的功能，如置顶、取色、贴图、右键菜单、状态栏管理、ntfs等等功能，后面将会补充到十几项功能。
...
> URL: https://travisbikkle.github.io/2024/10/how-did-i-develop-mactoys-pin-window/  
